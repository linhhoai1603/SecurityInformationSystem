    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <form action="personal-inf" method="post">
                ...
                <div class="form-group">
                    <label for="publicKey">Khóa xác nhận</label>
                    <textarea class="form-control" id="publicKey" rows="4" readonly>${sessionScope.userKeys.publicKey}</textarea>
                    <a href="enter-public-key.jsp" class="btn btn-secondary mt-2">Chỉnh sửa khóa xác nhận</a>
                </div>
