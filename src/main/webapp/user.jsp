...
<div class="container mt-5">
    ...
    <div class="row">
        ...
        <c:out value="${sessionScope.user.userkeys}" default="Không có userKey"/>
        ...
        <div class="col-md-9">
            <form action="personal-inf" method="post">
                ...
                <div class="form-group">
                    <label for="street">PublicKey</label>
                    <input type="text" class="form-control" id="pubKey" name="pubKey" placeholder="Nhập key xác nhận"
                           value="${sessionScope.user.userkeys.publicKey}" required>
                </div>
